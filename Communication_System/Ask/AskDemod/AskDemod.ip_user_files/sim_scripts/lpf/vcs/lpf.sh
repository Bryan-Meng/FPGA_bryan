...
design_libs=(xbip_utils_v3_0_14 axi_utils_v2_0_10 fir_compiler_v7_2_23 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work fir_compiler_v7_2_23 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.lpf -o lpf_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./lpf_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bryan/workspace/AXU3EG/vivado/AskDemod/AskDemod.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key lpf_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc lpf_simv.daidir vcs_lib c.obj)
