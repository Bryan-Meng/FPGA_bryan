...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L fir_compiler_v7_2_23 -L secureip -L xpm --snapshot lpf xil_defaultlib.lpf -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim lpf -key {Behavioral:sim_1:Functional:lpf} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb lpf.wdb xsim.dir libdpi.so)
