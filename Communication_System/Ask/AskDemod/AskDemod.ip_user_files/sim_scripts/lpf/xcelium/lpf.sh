...
#
# Script generated by Vivado on Wed Jun 11 20:59:54 CST 2025
...
#
# Usage        : lpf.sh
#                lpf.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                lpf.sh [-reset_run]
#                lpf.sh [-reset_log]
#                lpf.sh [-help]
#
...
#                script (type 'lpf.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_14 -libname axi_utils_v2_0_10 -libname fir_compiler_v7_2_23 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_14 axi_utils_v2_0_10 fir_compiler_v7_2_23 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "lpf.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./lpf.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work fir_compiler_v7_2_23 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.lpf
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.lpf -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bryan/workspace/AXU3EG/vivado/AskDemod/AskDemod.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log lpf_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./lpf.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: lpf.sh [-help]\n\
Usage: lpf.sh [-step]\n\
Usage: lpf.sh [-lib_map_path]\n\
Usage: lpf.sh [-reset_run]\n\
Usage: lpf.sh [-reset_log]\n\
Usage: lpf.sh [-keep_index]\n\
Usage: lpf.sh [-noclean_files]\n\n\
