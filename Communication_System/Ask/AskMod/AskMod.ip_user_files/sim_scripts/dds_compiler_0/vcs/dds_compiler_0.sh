...
design_libs=(xbip_utils_v3_0_14 axi_utils_v2_0_10 mult_gen_v12_0_22 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_10 floating_point_v7_1_19 dds_compiler_v6_0_26 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work dds_compiler_v6_0_26 $vhdlan_opts -vhdl08 \
  "../../../ipstatic/hdl/float_pkg.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vhdlan -work dds_compiler_v6_0_26 $vhdlan_opts \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bryan/workspace/AXU3EG/vivado/AskMod/AskMod.cache/compile_simlib/vcs"
  fi
