...
#
# Script generated by Vivado on Tue Jun 10 19:03:19 CST 2025
...
design_libs_elab="-libname xbip_utils_v3_0_14 -libname axi_utils_v2_0_10 -libname mult_gen_v12_0_22 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_pipe_v3_0_10 -libname floating_point_v7_1_19 -libname dds_compiler_v6_0_26 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_14 axi_utils_v2_0_10 mult_gen_v12_0_22 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_10 floating_point_v7_1_19 dds_compiler_v6_0_26 xil_defaultlib)
...
compile()
{
  ...
  xmvhdl -work dds_compiler_v6_0_26 -V200X $xmvhdl_opts \
  "../../../ipstatic/hdl/float_pkg.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work dds_compiler_v6_0_26 -V93 $xmvhdl_opts \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bryan/workspace/AXU3EG/vivado/AskMod/AskMod.cache/compile_simlib/xcelium"
  fi
